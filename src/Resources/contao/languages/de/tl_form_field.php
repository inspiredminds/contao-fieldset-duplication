...
$GLOBALS['TL_LANG']['tl_form_field']['notificationTokenTemplates'] = ['Notification Token Templates', 'Rendere Fieldset als Notification Token. Verfügbar unter <em>form_{name}_{format}.'];
